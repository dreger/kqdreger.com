...
Although the syntax parser could use some tweaking (and Markdown support for that matter), I personally liked Hemingway's presentation of "sentence syntax" over that of [Information Architect's Writer Pro]({% post_url archives/2013-12-19-writer-pro-for-mac %}). 
